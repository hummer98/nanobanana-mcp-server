...
class ProImageService:
    ...
    def generate_images(
    ...
    ) -> tuple[list[MCPImage], list[dict[str, Any]], dict[str, Any]]:
        """
        ...
        Returns:
            Tuple of (image_blocks_or_resource_links, metadata_list, generation_info)
            generation_info contains: total_requested, total_generated, errors (list or None)
        """
        ...
        with ProgressContext(
            ...
            # Include errors in metadata if any occurred
            generation_info = {
                "total_requested": n,
            ...
            return all_images, all_metadata, generation_info
